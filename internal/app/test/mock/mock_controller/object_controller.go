...
//
//	mockgen -source=object_controller.go -package=mock_controller -destination=../../test/mock/mock_controller/object_controller.go
//
...
func (mr *MockObjectControllerMockRecorder) CreateThumbnail(ctx, key, bucketName any) *gomock.Call {
