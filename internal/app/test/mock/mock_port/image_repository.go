...
//
//	mockgen -source=image_repository.go -package=mock_port -destination=../../test/mock/mock_port/image_repository.go
//
...
func (mr *MockImageRepositoryMockRecorder) Find(ctx, name, format, isThumbnail any) *gomock.Call {
...
func (mr *MockImageRepositoryMockRecorder) Save(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
