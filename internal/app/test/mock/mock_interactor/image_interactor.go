...
//
//	mockgen -source=image_interactor.go -package=mock_interactor -destination=../../test/mock/mock_interactor/image_interactor.go
//
...
func (mr *MockImageInteractorMockRecorder) CreateThumbnail(ctx, name, format any) *gomock.Call {
